...
Fusion of Sentinel-2 and Sentinel-3 data to improve Sentinel-3 spatial resolution
...
The folder `sentinel_data_fusion` is designed to contain the source
...
The only requirement is that the folder `sentinel_data_fusion` contains
...
another file. See the [README.md](./sentinel_data_fusion/README.md)
in the `sentinel_data_fusion` folder for more information.
...
the [README.md](./sentinel_data_fusion/README.md)
