...
```bash
$ python -m sentinel_data_fusion.make_dataset {your_arguments}
$ python -m sentinel_data_fusion.make_model {your_arguments}
$ python -m sentinel_data_fusion.compare_models {your_arguments}
```
...
```bash
$ python -m sentinel_data_fusion.dataset.make_dataset {your_arguments}
$ python -m sentinel_data_fusion.models.make_model {your_arguments}
$ python -m sentinel_data_fusion.visualization.compare_models {your_arguments}
```
